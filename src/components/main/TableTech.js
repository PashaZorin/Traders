...
const TableTech = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M249 26.0085V478.009"
        stroke="url(#paint1_linear_2_97)"
        strokeOpacity="0.4"
        strokeWidth="3"
        strokeLinecap="round"
        strokeDasharray="10 10"
      />
      <path
        d="M368 26.0085V478.009"
        stroke="url(#paint2_linear_2_97)"
        strokeOpacity="0.4"
        strokeWidth="3"
        strokeLinecap="round"
        strokeDasharray="10 10"
      ...
      <g filter="url(#filter0_d_2_97)">
        <rect
          ...
          height="430"
          rx="9.5"
          transform="rotate(90 453 250.009)"
          fill="#44FACE"
        />
      </g>
      <g filter="url(#filter1_d_2_97)">
        <rect
          ...
          height="76"
          rx="9.5"
          transform="rotate(90 99 380.009)"
          fill="#00CF6C"
        />
      </g>
      ...
      <g filter="url(#filter3_d_2_97)">
        <rect
          ...
          height="430"
          rx="9.5"
          transform="rotate(90 453 175.009)"
          fill="#09A2FE"
        />
      </g>
      <g filter="url(#filter4_d_2_97)">
        <rect
          ...
          height="245"
          rx="9.5"
          transform="rotate(90 268 110.009)"
          fill="#0C62EE"
        />
      </g>
      <g filter="url(#filter5_d_2_97)">
        <rect
          ...
          height="107"
          rx="9.5"
          transform="rotate(90 130 46.0085)"
          fill="#2B40BF"
        />
      </g>
      <path
        d="M14 221.009L506 221.009"
        stroke="url(#paint4_linear_2_97)"
        strokeOpacity="0.9"
        strokeWidth="3"
        strokeLinecap="round"
      />
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_2_97"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_2_97"
            result="shape"
          />
        </filter>
        <filter
